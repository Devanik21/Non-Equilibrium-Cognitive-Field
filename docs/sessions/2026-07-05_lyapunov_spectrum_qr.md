...
# NECF Session Log — 2026-07-05

**Session ID:** `NECF-2026-186-T3`
...
- Coupling $K = 0.8937$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.00406 | near-zero — marginal direction
| $\lambda_{{ 2 }}$ | -0.08597 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.28517 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.38309 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.48393 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.52946 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.55473 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.58877 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.00406** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -8.31402 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -9.28551 |
...
With $K = 0.8937$ and $N = 16$, the system is in the
...
The Lyapunov sum $\\sum_i \\lambda_i = -8.3140$ compared to
$\\text{tr}(J) = -9.2855$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = -0.0041$ provides a
...
---
*NECF-2026-186-T3 · generated 2026-07-05 · seed 20260705*
