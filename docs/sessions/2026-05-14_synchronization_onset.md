...
# NECF Session Log — 2026-05-14

**Session ID:** `NECF-2026-134-T0`
...
| Fitted scaling exponent $\\beta$ | **0.1820** (theory: 0.5000) |
| Fit quality $R^2$ | 0.6086 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.1820$
...
---
*NECF-2026-134-T0 · generated 2026-05-14 · seed 20260514*
