...
# NECF Session Log — 2026-04-30

**Session ID:** `NECF-2026-120-T0`
...
| Fitted scaling exponent $\\beta$ | **0.3481** (theory: 0.5000) |
| Fit quality $R^2$ | 0.4859 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.3481$
...
---
*NECF-2026-120-T0 · generated 2026-04-30 · seed 20260430*
