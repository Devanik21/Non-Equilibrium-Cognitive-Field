...
# NECF Session Log — 2026-07-31

**Session ID:** `NECF-2026-212-T1`
...
|---|---|---|---|
| 0.0100 | 1.27074 | 0.000062 | 0.03129 |
| 0.0243 | 1.99738 | 0.000082 | 0.04775 |
| 0.0591 | 2.48516 | 0.000083 | 0.02767 |
| 0.1436 | 3.28766 | 0.000070 | 0.00716 |
| 0.3490 | 3.43202 | 0.000092 | 0.13278 |
| 0.8483 | 3.45897 | 0.000074 | 0.03920 |
| 2.0620 | 3.46477 | 0.000081 | 0.06919 |
| 5.0119 | 3.46558 | 0.000082 | 0.05363 |
...
| Optimal temperature $\\kappa^*$ | **0.34903** |
| $H_w(\\kappa^*)$ | 3.43202 |
| Transition temperature $\\kappa_c$ | **0.01808** |
| Discrimination ratio at $\\kappa^*$: $H_w/\\ln N$ | 0.9903 |
...
$\\kappa^* = 0.3490$ lies above
this transition, in the
diffuse regime.
At $\\kappa^*$, the weight entropy is $3.43202$, representing
99.0% of the theoretical maximum $\\ln N = 3.4657$.
The default NECF value $\\kappa = 0.10$ sits at $H_w = 3.1519$.
...
deviates from
one order of magnitude of the empirical optimum $\\kappa^* = 0.3490$.

---
*NECF-2026-212-T1 · generated 2026-07-31 · seed 20260731*
