...
# NECF Session Log — 2026-04-19

**Session ID:** `NECF-2026-109-T3`
...
- Coupling $K = 0.8667$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.17319 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.28569 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.53777 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.59362 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.61430 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.67254 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.69770 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.72311 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.17319** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -10.20176 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -11.20058 |
...
With $K = 0.8667$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1732$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -10.2018$ compared to
$\\text{tr}(J) = -11.2006$ confirms internal consistency of the
...
---
*NECF-2026-109-T3 · generated 2026-04-19 · seed 20260419*
