...
# NECF Session Log — 2026-05-18

**Session ID:** `NECF-2026-138-T4`
...
- **Two-group initialisation:**
  ...
  $\\beta = 0.3$) and high-error ($\\varepsilon_h = 0.2893$,
  $N/2$ nodes, $\\beta = 1.5$)
...
|---|---|---|---|
| 0.020 | 690.8 | 691.3 | -0.1% |
| 0.050 | 694.1 | 695.4 | -0.2% |
| 0.100 | 734.0 | 744.2 | -1.4% |
| 0.300 | 922.2 | 984.9 | -6.4% |
| 1.000 | 1097.9 | 1226.0 | -10.4% |
| 2.500 | 1160.0 | 1315.1 | -11.8% |

### 3.2 Power-Law Fit

$$\\tau_{\\rm mix}(\\kappa) \\sim \\kappa^{0.1240}, \\quad R^2 = 0.9486$$
...
coupling matrix $W$.  The power law exponent $\\hat{\\alpha} = 0.1240$
...
---
*NECF-2026-138-T4 · generated 2026-05-18 · seed 20260518*
