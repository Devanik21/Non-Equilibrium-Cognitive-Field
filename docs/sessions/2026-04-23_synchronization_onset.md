...
# NECF Session Log — 2026-04-23

**Session ID:** `NECF-2026-113-T0`
...
| $K_c$ (empirical, $N=64$) | **0.050000** |
| Relative deviation | **-89.6%** |
| Finite-size background $r_{\\rm bg} \\sim N^{-1/2}$ | 0.1250 |
| Fitted scaling exponent $\\beta$ | **0.5551** (theory: 0.5000) |
| Fit quality $R^2$ | 0.8161 |
...
The empirical critical coupling $K_c^{\\rm emp} = 0.0500$ deviates
from the mean-field prediction $K_c^{\\rm th} = 0.4787$ by
-89.6%.  This is consistent with finite-size broadening: for
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.5551$
...
---
*NECF-2026-113-T0 · generated 2026-04-23 · seed 20260423*
