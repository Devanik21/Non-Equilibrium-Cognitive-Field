...
# NECF Session Log — 2026-03-26

**Session ID:** `NECF-2026-085-T0`
...
| Fitted scaling exponent $\\beta$ | **0.1442** (theory: 0.5000) |
| Fit quality $R^2$ | 0.6536 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.1442$
...
---
*NECF-2026-085-T0 · generated 2026-03-26 · seed 20260326*
