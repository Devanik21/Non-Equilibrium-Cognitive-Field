...
# NECF Session Log — 2026-05-28

**Session ID:** `NECF-2026-148-T0`
...
| Fitted scaling exponent $\\beta$ | **0.3171** (theory: 0.5000) |
| Fit quality $R^2$ | 0.3820 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.3171$
...
---
*NECF-2026-148-T0 · generated 2026-05-28 · seed 20260528*
