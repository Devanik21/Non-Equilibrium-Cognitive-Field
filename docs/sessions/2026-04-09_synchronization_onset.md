...
# NECF Session Log — 2026-04-09

**Session ID:** `NECF-2026-099-T0`
...
| Fitted scaling exponent $\\beta$ | **0.2374** (theory: 0.5000) |
| Fit quality $R^2$ | 0.8321 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.2374$
...
---
*NECF-2026-099-T0 · generated 2026-04-09 · seed 20260409*
