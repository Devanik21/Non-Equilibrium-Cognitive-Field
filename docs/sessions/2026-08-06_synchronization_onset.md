...
# NECF Session Log — 2026-08-06

**Session ID:** `NECF-2026-218-T0`
...
| Fitted scaling exponent $\\beta$ | **0.4297** (theory: 0.5000) |
| Fit quality $R^2$ | 0.4773 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.4297$
...
---
*NECF-2026-218-T0 · generated 2026-08-06 · seed 20260806*
