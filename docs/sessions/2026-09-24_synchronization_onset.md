...
# NECF Session Log — 2026-09-24

**Session ID:** `NECF-2026-267-T0`
...
| Fitted scaling exponent $\\beta$ | **0.2250** (theory: 0.5000) |
| Fit quality $R^2$ | 0.8106 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.2250$
...
---
*NECF-2026-267-T0 · generated 2026-09-24 · seed 20260924*
