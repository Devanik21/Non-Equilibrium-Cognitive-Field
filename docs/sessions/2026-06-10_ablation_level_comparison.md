...
# NECF Session Log — 2026-06-10

**Session ID:** `NECF-2026-161-T6`
...
|---|---|---|---|---|---|
| Level-1 | 0.03414 ± 0.02214 | [0.0042, 0.0770] | 0.0000966 | 0.00000 | 0 |
| Level-2 | 0.03626 ± 0.01742 | [0.0112, 0.0663] | 0.0000944 | 0.00002 | 0 |
| Level-3 | 0.04125 ± 0.02107 | [0.0079, 0.0846] | 0.0000724 | 0.00000 | 0 |
...
|---|---|
| $t$-statistic | 1.1389 |
| $p$-value (two-tailed) | 0.26038 |
| Cohen's $d$ | 0.3288 |
| $\\text{Var}(\\mathcal{L})$ ratio: Level-3 / Level-1 | **0.7496×** |
...
(fixed rules) is **not significant** (p ≥ 0.05).  Cohen's $d = 0.3288$ indicates a
small effect size.

The most discriminating observable at $T=600$ is
$\\text{Var}(\\mathcal{L}_i)$: the ratio Level-3 / Level-1 is
**0.7496×**, confirming that the NECF meta-dynamics produce
...
---
*NECF-2026-161-T6 · generated 2026-06-10 · seed 20260610*
