...
# NECF Session Log — 2026-06-21

**Session ID:** `NECF-2026-172-T3`
...
- Coupling $K = 0.7409$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.17284 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.31780 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.44809 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.48185 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.55334 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.56104 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.56684 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.56690 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.17284** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -8.64053 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -9.39286 |
...
With $K = 0.7409$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1728$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -8.6405$ compared to
$\\text{tr}(J) = -9.3929$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = -0.1728$ provides a
...
---
*NECF-2026-172-T3 · generated 2026-06-21 · seed 20260621*
