...
# NECF Session Log — 2026-05-24

**Session ID:** `NECF-2026-144-T3`
...
- Coupling $K = 0.8013$ (sampled with seed-based variation)
...
| $\lambda_{{ 2 }}$ | -0.56600 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.63607 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.67501 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.70041 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.70077 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.70719 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.72219 | negative — contracting direction
...
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -10.78414 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -10.72672 |
...
With $K = 0.8013$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1733$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -10.7841$ compared to
$\\text{tr}(J) = -10.7267$ confirms internal consistency of the
...
---
*NECF-2026-144-T3 · generated 2026-05-24 · seed 20260524*
