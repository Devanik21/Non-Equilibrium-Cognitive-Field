...
# NECF Session Log — 2026-08-17

**Session ID:** `NECF-2026-229-T4`
...
- **Two-group initialisation:**
  low-error ($\\varepsilon_l = 0.0696$, $N/2 = 16$ nodes,
  $\\beta = 0.3$) and high-error ($\\varepsilon_h = 0.2147$,
  $N/2$ nodes, $\\beta = 1.5$)
...
|---|---|---|---|
| 0.020 | 931.6 | 932.3 | -0.1% |
| 0.050 | 963.2 | 982.9 | -2.0% |
| 0.100 | 1060.7 | 1150.1 | -7.8% |
| 0.300 | 1238.3 | 1506.2 | -17.8% |
| 1.000 | 1336.2 | 1737.6 | -23.1% |
| 2.500 | 1364.8 | 1810.8 | -24.6% |

### 3.2 Power-Law Fit

$$\\tau_{\\rm mix}(\\kappa) \\sim \\kappa^{0.0887}, \\quad R^2 = 0.9540$$
...
coupling matrix $W$.  The power law exponent $\\hat{\\alpha} = 0.0887$
...
---
*NECF-2026-229-T4 · generated 2026-08-17 · seed 20260817*
