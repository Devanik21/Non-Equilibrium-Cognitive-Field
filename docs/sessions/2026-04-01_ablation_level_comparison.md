...
# NECF Session Log — 2026-04-01

**Session ID:** `NECF-2026-091-T6`
...
|---|---|---|---|---|---|
| Level-1 | 0.04359 ± 0.02346 | [0.0092, 0.0967] | 0.0000983 | 0.00000 | 0 |
| Level-2 | 0.03548 ± 0.02292 | [0.0054, 0.0961] | 0.0000983 | 0.00002 | 0 |
| Level-3 | 0.04528 ± 0.01955 | [0.0113, 0.0745] | 0.0000697 | 0.00000 | 0 |
...
|---|---|
| $t$-statistic | 0.2703 |
| $p$-value (two-tailed) | 0.78810 |
| Cohen's $d$ | 0.0780 |
| $\\text{Var}(\\mathcal{L})$ ratio: Level-3 / Level-1 | **0.7091×** |
...
(fixed rules) is **not significant** (p ≥ 0.05).  Cohen's $d = 0.0780$ indicates a
negligible effect size.

The most discriminating observable at $T=600$ is
$\\text{Var}(\\mathcal{L}_i)$: the ratio Level-3 / Level-1 is
**0.7091×**, confirming that the NECF meta-dynamics produce
...
---
*NECF-2026-091-T6 · generated 2026-04-01 · seed 20260401*
