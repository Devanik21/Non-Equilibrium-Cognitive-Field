...
# NECF Session Log — 2026-06-12

**Session ID:** `NECF-2026-163-T1`
...
|---|---|---|---|
| 0.0100 | 1.07030 | 0.000084 | 0.13880 |
| 0.0243 | 1.86545 | 0.000065 | 0.09672 |
| 0.0591 | 2.30578 | 0.000101 | 0.03236 |
| 0.1436 | 3.29506 | 0.000058 | 0.07730 |
| 0.3490 | 3.43594 | 0.000061 | 0.07903 |
| 0.8483 | 3.46036 | 0.000092 | 0.06177 |
| 2.0620 | 3.46481 | 0.000080 | 0.06074 |
| 5.0119 | 3.46553 | 0.000073 | 0.04733 |
...
| $H_w(\\kappa^*)$ | 3.46517 |
| Transition temperature $\\kappa_c$ | **0.07943** |
...
$\\kappa_c = 0.0794$, identified as the peak of
$dH_w/d\\ln\\kappa$.  The optimal operating point
$\\kappa^* = 2.7724$ lies above
this transition, in the
diffuse regime.
At $\\kappa^*$, the weight entropy is $3.46517$, representing
100.0% of the theoretical maximum $\\ln N = 3.4657$.
The default NECF value $\\kappa = 0.10$ sits at $H_w = 3.2202$.
...
---
*NECF-2026-163-T1 · generated 2026-06-12 · seed 20260612*
