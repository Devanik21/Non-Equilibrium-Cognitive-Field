...
# NECF Session Log — 2026-08-13

**Session ID:** `NECF-2026-225-T0`
...
| Fitted scaling exponent $\\beta$ | **0.2114** (theory: 0.5000) |
| Fit quality $R^2$ | 0.7609 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.2114$
...
---
*NECF-2026-225-T0 · generated 2026-08-13 · seed 20260813*
