...
# NECF Session Log — 2026-06-26

**Session ID:** `NECF-2026-177-T1`
...
|---|---|---|---|
| 0.0100 | 1.65571 | 0.000085 | 0.05507 |
| 0.0243 | 2.01575 | 0.000107 | 0.00517 |
| 0.0591 | 2.83942 | 0.000081 | 0.10392 |
| 0.1436 | 3.31668 | 0.000087 | 0.01033 |
| 0.3490 | 3.42367 | 0.000081 | 0.08285 |
| 0.8483 | 3.46137 | 0.000083 | 0.08444 |
| 2.0620 | 3.46446 | 0.000084 | 0.05648 |
| 5.0119 | 3.46561 | 0.000067 | 0.07575 |
...
| Optimal temperature $\\kappa^*$ | **0.05908** |
| $H_w(\\kappa^*)$ | 2.83942 |
| Transition temperature $\\kappa_c$ | **0.05908** |
| Discrimination ratio at $\\kappa^*$: $H_w/\\ln N$ | 0.8193 |
...
$\\kappa_c = 0.0591$, identified as the peak of
$dH_w/d\\ln\\kappa$.  The optimal operating point
$\\kappa^* = 0.0591$ lies above
this transition, in the
diffuse regime.
At $\\kappa^*$, the weight entropy is $2.83942$, representing
81.9% of the theoretical maximum $\\ln N = 3.4657$.
The default NECF value $\\kappa = 0.10$ sits at $H_w = 3.1354$.
...
is within
one order of magnitude of the empirical optimum $\\kappa^* = 0.0591$.

---
*NECF-2026-177-T1 · generated 2026-06-26 · seed 20260626*
