...
# NECF Session Log — 2026-07-23

**Session ID:** `NECF-2026-204-T0`
...
| $K_c$ (empirical, $N=64$) | **0.231481** |
| Relative deviation | **-51.6%** |
| Finite-size background $r_{\\rm bg} \\sim N^{-1/2}$ | 0.1250 |
| Fitted scaling exponent $\\beta$ | **0.5992** (theory: 0.5000) |
| Fit quality $R^2$ | 0.6498 |
...
The empirical critical coupling $K_c^{\\rm emp} = 0.2315$ deviates
from the mean-field prediction $K_c^{\\rm th} = 0.4787$ by
-51.6%.  This is consistent with finite-size broadening: for
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.5992$
...
---
*NECF-2026-204-T0 · generated 2026-07-23 · seed 20260723*
