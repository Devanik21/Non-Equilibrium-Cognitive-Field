...
# NECF Session Log — 2026-05-23

**Session ID:** `NECF-2026-143-T2`
...
|---|---|---|---|---|---|
| 0.01 | ✓ r=0.042 | ✓ r=0.112 | ✓ r=0.042 | ✓ r=0.059 | ↓ r=0.012 |
| 0.05 | ✓ r=0.072 | ✓ r=0.063 | ✓ r=0.084 | ✓ r=0.046 | ✓ r=0.082 |
| 0.10 | ↓ r=0.031 | ✓ r=0.064 | ✓ r=0.072 | ✓ r=0.074 | ↓ r=0.028 |
| 0.25 | ✓ r=0.072 | ↓ r=0.024 | ✓ r=0.057 | ✓ r=0.065 | ↓ r=0.003 |
| 0.50 | ✓ r=0.084 | ✓ r=0.089 | ↓ r=0.012 | ↓ r=0.031 | ✓ r=0.043 |
| 1.00 | ✓ r=0.064 | ↓ r=0.016 | ↓ r=0.016 | ↓ r=0.023 | ↓ r=0.011 |
...
| Best operating point $(\lambda^*, \\delta^*)$ | $(0.01,\\;0.2)$ |
...
---
*NECF-2026-143-T2 · generated 2026-05-23 · seed 20260523*
