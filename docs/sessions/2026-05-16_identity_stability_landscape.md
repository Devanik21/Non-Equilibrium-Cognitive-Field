...
# NECF Session Log — 2026-05-16

**Session ID:** `NECF-2026-136-T2`
...
|---|---|---|---|---|---|
| 0.01 | ↓ r=0.013 | ↓ r=0.033 | ✓ r=0.064 | ✓ r=0.068 | ✓ r=0.070 |
| 0.05 | ↓ r=0.024 | ↓ r=0.028 | ✓ r=0.092 | ✓ r=0.047 | ✓ r=0.042 |
| 0.10 | ↓ r=0.023 | ✓ r=0.051 | ✓ r=0.049 | ✓ r=0.064 | ↓ r=0.018 |
| 0.25 | ↓ r=0.013 | ✓ r=0.043 | ✓ r=0.066 | ↓ r=0.019 | ✓ r=0.045 |
| 0.50 | ✓ r=0.042 | ↓ r=0.035 | ✓ r=0.078 | ✓ r=0.079 | ✓ r=0.120 |
| 1.00 | ↓ r=0.037 | ✓ r=0.053 | ↓ r=0.030 | ✓ r=0.094 | ✓ r=0.099 |
...
| Best operating point $(\lambda^*, \\delta^*)$ | $(0.5,\\;0.8)$ |
| $r$ at best point | 0.12007 |
...
---
*NECF-2026-136-T2 · generated 2026-05-16 · seed 20260516*
