...
# NECF Session Log — 2026-05-31

**Session ID:** `NECF-2026-151-T3`
...
- Coupling $K = 0.7820$ (sampled with seed-based variation)
...
| $\lambda_{{ 2 }}$ | -0.38191 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.43368 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.59709 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.59975 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.60507 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.62373 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.64778 | negative — contracting direction
...
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -9.52361 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -9.15319 |
...
With $K = 0.7820$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1733$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -9.5236$ compared to
$\\text{tr}(J) = -9.1532$ confirms internal consistency of the
...
---
*NECF-2026-151-T3 · generated 2026-05-31 · seed 20260531*
