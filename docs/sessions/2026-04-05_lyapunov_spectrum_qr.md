...
# NECF Session Log — 2026-04-05

**Session ID:** `NECF-2026-095-T3`
...
- Coupling $K = 0.7372$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | +0.16456 | positive — expansion direction
| $\lambda_{{ 2 }}$ | +0.13622 | positive — expansion direction
| $\lambda_{{ 3 }}$ | -0.01068 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.06882 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.09585 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.13654 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.17878 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.21091 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **+0.16456** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -2.69573 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -6.08856 |
| Kaplan–Yorke dimension $D_{\\rm KY}$ | **5.9186** |
...
With $K = 0.7372$ and $N = 16$, the system is in the
**chaotic** regime
($\\lambda_1 = +0.1646$).
The Kaplan–Yorke dimension $D_{\\rm KY} = 5.919$ estimates the fractal
...
The Lyapunov sum $\\sum_i \\lambda_i = -2.6957$ compared to
$\\text{tr}(J) = -6.0886$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = +0.1646$ provides a
...
---
*NECF-2026-095-T3 · generated 2026-04-05 · seed 20260405*
