...
# NECF Session Log — 2026-08-16

**Session ID:** `NECF-2026-228-T3`
...
- Coupling $K = 0.6413$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.17018 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.21101 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.22133 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.24953 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.28516 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.30161 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.31724 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.32812 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.17018** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -5.52550 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -6.85744 |
...
With $K = 0.6413$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1702$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -5.5255$ compared to
$\\text{tr}(J) = -6.8574$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = -0.1702$ provides a
...
---
*NECF-2026-228-T3 · generated 2026-08-16 · seed 20260816*
