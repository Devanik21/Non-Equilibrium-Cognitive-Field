...
# NECF Session Log — 2026-08-03

**Session ID:** `NECF-2026-215-T4`
...
- **Two-group initialisation:**
  ...
  $\\beta = 0.3$) and high-error ($\\varepsilon_h = 0.2583$,
  $N/2$ nodes, $\\beta = 1.5$)
...
|---|---|---|---|
| 0.020 | 774.0 | 774.5 | -0.1% |
| 0.050 | 783.3 | 788.3 | -0.6% |
| 0.100 | 842.8 | 877.9 | -4.0% |
| 0.300 | 1020.2 | 1170.3 | -12.8% |
| 1.000 | 1147.9 | 1407.7 | -18.5% |
| 2.500 | 1188.7 | 1489.0 | -20.2% |

### 3.2 Power-Law Fit

$$\\tau_{\\rm mix}(\\kappa) \\sim \\kappa^{0.1023}, \\quad R^2 = 0.9556$$
...
coupling matrix $W$.  The power law exponent $\\hat{\\alpha} = 0.1023$
...
---
*NECF-2026-215-T4 · generated 2026-08-03 · seed 20260803*
