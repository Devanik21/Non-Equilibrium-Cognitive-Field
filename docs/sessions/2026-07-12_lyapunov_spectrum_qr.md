...
# NECF Session Log — 2026-07-12

**Session ID:** `NECF-2026-193-T3`
...
- Coupling $K = 0.8078$ (sampled with seed-based variation)
...
| $\lambda_{{ 2 }}$ | -0.67563 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.70502 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.71536 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.73880 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.73935 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.76093 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.76702 | negative — contracting direction
...
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -11.47569 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -11.51988 |
...
With $K = 0.8078$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1733$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -11.4757$ compared to
$\\text{tr}(J) = -11.5199$ confirms internal consistency of the
...
---
*NECF-2026-193-T3 · generated 2026-07-12 · seed 20260712*
