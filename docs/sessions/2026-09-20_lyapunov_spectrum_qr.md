...
# NECF Session Log — 2026-09-20

**Session ID:** `NECF-2026-263-T3`
...
- Coupling $K = 0.6131$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | +0.08235 | positive — expansion direction
| $\lambda_{{ 2 }}$ | +0.07076 | positive — expansion direction
| $\lambda_{{ 3 }}$ | +0.04029 | positive — expansion direction
| $\lambda_{{ 4 }}$ | +0.02465 | positive — expansion direction
| $\lambda_{{ 5 }}$ | +0.01811 | positive — expansion direction
| $\lambda_{{ 6 }}$ | -0.00566 | near-zero — marginal direction
| $\lambda_{{ 7 }}$ | -0.01494 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.03208 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **+0.08235** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -1.15551 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -2.00174 |
| Kaplan–Yorke dimension $D_{\\rm KY}$ | **10.2866** |
...
With $K = 0.6131$ and $N = 16$, the system is in the
**chaotic** regime
($\\lambda_1 = +0.0824$).
The Kaplan–Yorke dimension $D_{\\rm KY} = 10.287$ estimates the fractal
...
The Lyapunov sum $\\sum_i \\lambda_i = -1.1555$ compared to
$\\text{tr}(J) = -2.0017$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = +0.0824$ provides a
...
---
*NECF-2026-263-T3 · generated 2026-09-20 · seed 20260920*
