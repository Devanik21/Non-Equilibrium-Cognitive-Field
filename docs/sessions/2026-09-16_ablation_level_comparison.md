...
# NECF Session Log — 2026-09-16

**Session ID:** `NECF-2026-259-T6`
...
|---|---|---|---|---|---|
| Level-1 | 0.03581 ± 0.01557 | [0.0120, 0.0654] | 0.0000964 | 0.00000 | 0 |
| Level-2 | 0.03308 ± 0.02536 | [0.0075, 0.0868] | 0.0000992 | 0.00002 | 0 |
| Level-3 | 0.03699 ± 0.02161 | [0.0044, 0.0869] | 0.0000740 | 0.00000 | 0 |
...
|---|---|
| $t$-statistic | 0.2156 |
| $p$-value (two-tailed) | 0.83018 |
| Cohen's $d$ | 0.0623 |
| $\\text{Var}(\\mathcal{L})$ ratio: Level-3 / Level-1 | **0.7671×** |
...
(fixed rules) is **not significant** (p ≥ 0.05).  Cohen's $d = 0.0623$ indicates a
negligible effect size.

The most discriminating observable at $T=600$ is
$\\text{Var}(\\mathcal{L}_i)$: the ratio Level-3 / Level-1 is
**0.7671×**, confirming that the NECF meta-dynamics produce
...
---
*NECF-2026-259-T6 · generated 2026-09-16 · seed 20260916*
