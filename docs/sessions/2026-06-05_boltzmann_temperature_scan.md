...
# NECF Session Log — 2026-06-05

**Session ID:** `NECF-2026-156-T1`
...
|---|---|---|---|
| 0.0100 | 0.80883 | 0.000073 | 0.10642 |
| 0.0243 | 1.91607 | 0.000083 | 0.07444 |
| 0.0591 | 2.60412 | 0.000084 | 0.07999 |
| 0.1436 | 3.33558 | 0.000082 | 0.04344 |
| 0.3490 | 3.42230 | 0.000075 | 0.04619 |
| 0.8483 | 3.45905 | 0.000086 | 0.02190 |
| 2.0620 | 3.46457 | 0.000081 | 0.07993 |
| 5.0119 | 3.46551 | 0.000076 | 0.02757 |
...
| Optimal temperature $\\kappa^*$ | **1.53361** |
| $H_w(\\kappa^*)$ | 3.46363 |
| Transition temperature $\\kappa_c$ | **0.02431** |
| Discrimination ratio at $\\kappa^*$: $H_w/\\ln N$ | 0.9994 |
...
$\\kappa^* = 1.5336$ lies above
this transition, in the
diffuse regime.
At $\\kappa^*$, the weight entropy is $3.46363$, representing
99.9% of the theoretical maximum $\\ln N = 3.4657$.
The default NECF value $\\kappa = 0.10$ sits at $H_w = 3.1361$.
...
deviates from
one order of magnitude of the empirical optimum $\\kappa^* = 1.5336$.

---
*NECF-2026-156-T1 · generated 2026-06-05 · seed 20260605*
