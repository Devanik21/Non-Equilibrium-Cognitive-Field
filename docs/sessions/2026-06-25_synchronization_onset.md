...
# NECF Session Log — 2026-06-25

**Session ID:** `NECF-2026-176-T0`
...
| Fitted scaling exponent $\\beta$ | **0.4485** (theory: 0.5000) |
| Fit quality $R^2$ | 0.7115 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.4485$
...
---
*NECF-2026-176-T0 · generated 2026-06-25 · seed 20260625*
