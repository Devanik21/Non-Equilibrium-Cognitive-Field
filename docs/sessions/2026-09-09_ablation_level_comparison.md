...
# NECF Session Log — 2026-09-09

**Session ID:** `NECF-2026-252-T6`
...
|---|---|---|---|---|---|
| Level-1 | 0.04244 ± 0.02017 | [0.0131, 0.0817] | 0.0000944 | 0.00000 | 0 |
| Level-2 | 0.03490 ± 0.01632 | [0.0080, 0.0661] | 0.0000929 | 0.00002 | 0 |
| Level-3 | 0.03445 ± 0.01769 | [0.0133, 0.0729] | 0.0000719 | 0.00000 | 0 |
...
|---|---|
| $t$-statistic | -1.4586 |
| $p$-value (two-tailed) | 0.15120 |
| Cohen's $d$ | -0.4210 |
| $\\text{Var}(\\mathcal{L})$ ratio: Level-3 / Level-1 | **0.7624×** |
...
(fixed rules) is **not significant** (p ≥ 0.05).  Cohen's $d = -0.4210$ indicates a
small effect size.

The most discriminating observable at $T=600$ is
$\\text{Var}(\\mathcal{L}_i)$: the ratio Level-3 / Level-1 is
**0.7624×**, confirming that the NECF meta-dynamics produce
...
---
*NECF-2026-252-T6 · generated 2026-09-09 · seed 20260909*
