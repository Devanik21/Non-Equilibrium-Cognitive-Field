...
# NECF Session Log — 2026-08-21

**Session ID:** `NECF-2026-233-T1`
...
|---|---|---|---|
| 0.0100 | 1.43108 | 0.000095 | 0.04114 |
| 0.0243 | 1.88002 | 0.000118 | 0.03014 |
| 0.0591 | 2.66040 | 0.000083 | 0.08790 |
| 0.1436 | 3.33024 | 0.000077 | 0.02485 |
| 0.3490 | 3.44174 | 0.000080 | 0.06572 |
| 0.8483 | 3.45929 | 0.000086 | 0.06600 |
| 2.0620 | 3.46490 | 0.000087 | 0.06196 |
| 5.0119 | 3.46561 | 0.000081 | 0.01546 |
...
| Optimal temperature $\\kappa^*$ | **0.03268** |
| $H_w(\\kappa^*)$ | 2.35671 |
| Transition temperature $\\kappa_c$ | **0.02431** |
| Discrimination ratio at $\\kappa^*$: $H_w/\\ln N$ | 0.6800 |
...
$\\kappa^* = 0.0327$ lies above
this transition, in the
diffuse regime.
At $\\kappa^*$, the weight entropy is $2.35671$, representing
68.0% of the theoretical maximum $\\ln N = 3.4657$.
The default NECF value $\\kappa = 0.10$ sits at $H_w = 3.1579$.
...
is within
one order of magnitude of the empirical optimum $\\kappa^* = 0.0327$.

---
*NECF-2026-233-T1 · generated 2026-08-21 · seed 20260821*
