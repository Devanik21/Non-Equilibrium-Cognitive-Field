...
# NECF Session Log — 2026-09-02

**Session ID:** `NECF-2026-245-T6`
...
|---|---|---|---|---|---|
| Level-1 | 0.03596 ± 0.01652 | [0.0124, 0.0670] | 0.0000987 | 0.00000 | 0 |
| Level-2 | 0.04171 ± 0.02053 | [0.0052, 0.0730] | 0.0000999 | 0.00002 | 0 |
| Level-3 | 0.03897 ± 0.01693 | [0.0093, 0.0652] | 0.0000750 | 0.00000 | 0 |
...
|---|---|
| $t$-statistic | 0.6235 |
| $p$-value (two-tailed) | 0.53589 |
| Cohen's $d$ | 0.1800 |
| $\\text{Var}(\\mathcal{L})$ ratio: Level-3 / Level-1 | **0.7600×** |
...
(fixed rules) is **not significant** (p ≥ 0.05).  Cohen's $d = 0.1800$ indicates a
negligible effect size.

The most discriminating observable at $T=600$ is
$\\text{Var}(\\mathcal{L}_i)$: the ratio Level-3 / Level-1 is
**0.7600×**, confirming that the NECF meta-dynamics produce
...
---
*NECF-2026-245-T6 · generated 2026-09-02 · seed 20260902*
