...
# NECF Session Log — 2026-07-16

**Session ID:** `NECF-2026-197-T0`
...
| $K_c$ (empirical, $N=64$) | **0.594444** |
| Relative deviation | **+24.2%** |
| Finite-size background $r_{\\rm bg} \\sim N^{-1/2}$ | 0.1250 |
| Fitted scaling exponent $\\beta$ | **0.1158** (theory: 0.5000) |
| Fit quality $R^2$ | 0.5731 |
...
The empirical critical coupling $K_c^{\\rm emp} = 0.5944$ deviates
from the mean-field prediction $K_c^{\\rm th} = 0.4787$ by
+24.2%.  This is consistent with finite-size broadening: for
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.1158$
...
---
*NECF-2026-197-T0 · generated 2026-07-16 · seed 20260716*
