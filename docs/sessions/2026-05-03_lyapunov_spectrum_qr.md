...
# NECF Session Log — 2026-05-03

**Session ID:** `NECF-2026-123-T3`
...
- Coupling $K = 0.7655$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.17322 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.33409 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.47301 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.49024 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.51533 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.52102 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.55493 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.58027 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.17322** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -8.62418 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -9.90341 |
...
With $K = 0.7655$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1732$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -8.6242$ compared to
$\\text{tr}(J) = -9.9034$ confirms internal consistency of the
...
---
*NECF-2026-123-T3 · generated 2026-05-03 · seed 20260503*
