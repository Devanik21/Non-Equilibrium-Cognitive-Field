...
# NECF Session Log — 2026-09-23

**Session ID:** `NECF-2026-266-T6`
...
|---|---|---|---|---|---|
| Level-1 | 0.03337 ± 0.01514 | [0.0094, 0.0649] | 0.0000985 | 0.00000 | 0 |
| Level-2 | 0.03489 ± 0.01720 | [0.0105, 0.0705] | 0.0000997 | 0.00002 | 0 |
| Level-3 | 0.03814 ± 0.01639 | [0.0134, 0.0687] | 0.0000744 | 0.00000 | 0 |
...
|---|---|
| $t$-statistic | 1.0469 |
| $p$-value (two-tailed) | 0.30038 |
| Cohen's $d$ | 0.3022 |
| $\\text{Var}(\\mathcal{L})$ ratio: Level-3 / Level-1 | **0.7552×** |
...
(fixed rules) is **not significant** (p ≥ 0.05).  Cohen's $d = 0.3022$ indicates a
small effect size.

The most discriminating observable at $T=600$ is
$\\text{Var}(\\mathcal{L}_i)$: the ratio Level-3 / Level-1 is
**0.7552×**, confirming that the NECF meta-dynamics produce
...
---
*NECF-2026-266-T6 · generated 2026-09-23 · seed 20260923*
