...
# NECF Session Log — 2026-08-02

**Session ID:** `NECF-2026-214-T3`
...
- Coupling $K = 0.6242$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | +0.08207 | positive — expansion direction
| $\lambda_{{ 2 }}$ | +0.05152 | positive — expansion direction
| $\lambda_{{ 3 }}$ | +0.04210 | positive — expansion direction
| $\lambda_{{ 4 }}$ | +0.02621 | positive — expansion direction
| $\lambda_{{ 5 }}$ | -0.02503 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.19456 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.24456 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.30911 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **+0.08207** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -3.41855 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -4.15074 |
| Kaplan–Yorke dimension $D_{\\rm KY}$ | **5.9091** |
| Number of positive exponents | 4 / 16 |
...
With $K = 0.6242$ and $N = 16$, the system is in the
**chaotic** regime
($\\lambda_1 = +0.0821$).
The Kaplan–Yorke dimension $D_{\\rm KY} = 5.909$ estimates the fractal
...
The Lyapunov sum $\\sum_i \\lambda_i = -3.4186$ compared to
$\\text{tr}(J) = -4.1507$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = +0.0821$ provides a
...
---
*NECF-2026-214-T3 · generated 2026-08-02 · seed 20260802*
