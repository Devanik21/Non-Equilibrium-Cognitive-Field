...
# NECF Session Log — 2026-08-12

**Session ID:** `NECF-2026-224-T6`
...
|---|---|---|---|---|---|
| Level-1 | 0.03811 ± 0.01952 | [0.0114, 0.0715] | 0.0000962 | 0.00000 | 0 |
| Level-2 | 0.05323 ± 0.02882 | [0.0105, 0.1190] | 0.0000987 | 0.00002 | 0 |
| Level-3 | 0.03761 ± 0.01549 | [0.0140, 0.0649] | 0.0000724 | 0.00000 | 0 |
...
|---|---|
| $t$-statistic | -0.0981 |
| $p$-value (two-tailed) | 0.92226 |
| Cohen's $d$ | -0.0283 |
| $\\text{Var}(\\mathcal{L})$ ratio: Level-3 / Level-1 | **0.7522×** |
...
(fixed rules) is **not significant** (p ≥ 0.05).  Cohen's $d = -0.0283$ indicates a
negligible effect size.

The most discriminating observable at $T=600$ is
$\\text{Var}(\\mathcal{L}_i)$: the ratio Level-3 / Level-1 is
**0.7522×**, confirming that the NECF meta-dynamics produce
...
---
*NECF-2026-224-T6 · generated 2026-08-12 · seed 20260812*
