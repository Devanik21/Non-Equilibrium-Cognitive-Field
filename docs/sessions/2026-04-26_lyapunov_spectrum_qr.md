...
# NECF Session Log — 2026-04-26

**Session ID:** `NECF-2026-116-T3`
...
- Coupling $K = 0.7773$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.06511 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.15973 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.21319 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.39131 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.45965 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.50036 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.57106 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.57254 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.06511** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -7.76821 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -7.70707 |
...
With $K = 0.7773$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.0651$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -7.7682$ compared to
$\\text{tr}(J) = -7.7071$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = -0.0651$ provides a
...
---
*NECF-2026-116-T3 · generated 2026-04-26 · seed 20260426*
