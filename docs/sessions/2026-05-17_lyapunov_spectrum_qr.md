...
# NECF Session Log — 2026-05-17

**Session ID:** `NECF-2026-137-T3`
...
- Coupling $K = 0.7407$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.00197 | near-zero — marginal direction
| $\lambda_{{ 2 }}$ | -0.01059 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.05012 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.12982 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.17091 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.19361 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.23205 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.26447 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.00197** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -4.27439 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -3.09877 |
| Kaplan–Yorke dimension $D_{\\rm KY}$ | **0.0000** |
| Number of positive exponents | 0 / 16 |
| Dynamical regime | Marginal (λ₁ ≈ 0) |

---

## 4. Interpretation

With $K = 0.7407$ and $N = 16$, the system is in the
...
The Lyapunov sum $\\sum_i \\lambda_i = -4.2744$ compared to
$\\text{tr}(J) = -3.0988$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = -0.0020$ provides a
...
---
*NECF-2026-137-T3 · generated 2026-05-17 · seed 20260517*
