...
# NECF Session Log — 2026-06-07

**Session ID:** `NECF-2026-158-T3`
...
- Coupling $K = 0.8137$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.17229 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.30478 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.37706 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.50198 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.51528 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.59166 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.60093 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.60818 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.17229** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -9.11595 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -9.63784 |
...
With $K = 0.8137$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1723$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -9.1159$ compared to
$\\text{tr}(J) = -9.6378$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = -0.1723$ provides a
...
---
*NECF-2026-158-T3 · generated 2026-06-07 · seed 20260607*
