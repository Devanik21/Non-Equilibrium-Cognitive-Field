...
# NECF Session Log — 2026-07-01

**Session ID:** `NECF-2026-182-T6`
...
|---|---|---|---|---|---|
| Level-1 | 0.03968 ± 0.02101 | [0.0104, 0.0794] | 0.0000931 | 0.00000 | 0 |
| Level-2 | 0.03964 ± 0.01895 | [0.0086, 0.0730] | 0.0000952 | 0.00002 | 0 |
| Level-3 | 0.03601 ± 0.01865 | [0.0051, 0.0766] | 0.0000763 | 0.00000 | 0 |
...
|---|---|
| $t$-statistic | -0.6388 |
| $p$-value (two-tailed) | 0.52599 |
| Cohen's $d$ | -0.1844 |
| $\\text{Var}(\\mathcal{L})$ ratio: Level-3 / Level-1 | **0.8194×** |
...
(fixed rules) is **not significant** (p ≥ 0.05).  Cohen's $d = -0.1844$ indicates a
negligible effect size.

The most discriminating observable at $T=600$ is
$\\text{Var}(\\mathcal{L}_i)$: the ratio Level-3 / Level-1 is
**0.8194×**, confirming that the NECF meta-dynamics produce
...
---
*NECF-2026-182-T6 · generated 2026-07-01 · seed 20260701*
