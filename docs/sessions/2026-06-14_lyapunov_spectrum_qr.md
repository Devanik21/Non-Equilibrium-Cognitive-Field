...
# NECF Session Log — 2026-06-14

**Session ID:** `NECF-2026-165-T3`
...
- Coupling $K = 0.8305$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.17326 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.38386 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.54497 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.62068 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.64567 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.67484 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.67914 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.68688 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.17326** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -10.20408 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -11.55079 |
...
With $K = 0.8305$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1733$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -10.2041$ compared to
$\\text{tr}(J) = -11.5508$ confirms internal consistency of the
...
---
*NECF-2026-165-T3 · generated 2026-06-14 · seed 20260614*
