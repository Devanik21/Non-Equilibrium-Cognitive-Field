...
# NECF Session Log — 2026-08-05

**Session ID:** `NECF-2026-217-T6`
...
|---|---|---|---|---|---|
| Level-1 | 0.04076 ± 0.02151 | [0.0101, 0.0774] | 0.0000967 | 0.00000 | 0 |
| Level-2 | 0.03990 ± 0.01682 | [0.0122, 0.0690] | 0.0000971 | 0.00002 | 0 |
| Level-3 | 0.03633 ± 0.01692 | [0.0064, 0.0731] | 0.0000765 | 0.00000 | 0 |
...
|---|---|
| $t$-statistic | -0.7932 |
| $p$-value (two-tailed) | 0.43154 |
| Cohen's $d$ | -0.2290 |
| $\\text{Var}(\\mathcal{L})$ ratio: Level-3 / Level-1 | **0.7909×** |
...
(fixed rules) is **not significant** (p ≥ 0.05).  Cohen's $d = -0.2290$ indicates a
small effect size.

The most discriminating observable at $T=600$ is
$\\text{Var}(\\mathcal{L}_i)$: the ratio Level-3 / Level-1 is
**0.7909×**, confirming that the NECF meta-dynamics produce
...
---
*NECF-2026-217-T6 · generated 2026-08-05 · seed 20260805*
