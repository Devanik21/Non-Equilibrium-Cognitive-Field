...
# NECF Session Log — 2026-06-06

**Session ID:** `NECF-2026-157-T2`
...
|---|---|---|---|---|---|
| 0.01 | ↓ r=0.020 | ↓ r=0.034 | ↓ r=0.027 | ↓ r=0.004 | ✓ r=0.085 |
| 0.05 | ✓ r=0.103 | ✓ r=0.070 | ✓ r=0.045 | ↓ r=0.008 | ↓ r=0.039 |
| 0.10 | ↓ r=0.040 | ↓ r=0.001 | ✓ r=0.049 | ✓ r=0.080 | ↓ r=0.035 |
| 0.25 | ↓ r=0.033 | ✓ r=0.047 | ✓ r=0.049 | ✓ r=0.045 | ↓ r=0.038 |
| 0.50 | ↓ r=0.029 | ✓ r=0.057 | ↓ r=0.015 | ✓ r=0.104 | ↓ r=0.035 |
| 1.00 | ↓ r=0.029 | ✓ r=0.052 | ✓ r=0.097 | ↓ r=0.012 | ✓ r=0.092 |
...
| Best operating point $(\lambda^*, \\delta^*)$ | $(0.5,\\;0.5)$ |
| $r$ at best point | 0.10400 |
...
---
*NECF-2026-157-T2 · generated 2026-06-06 · seed 20260606*
