...
# NECF Session Log — 2026-04-02

**Session ID:** `NECF-2026-092-T0`
...
| Fitted scaling exponent $\\beta$ | **0.3064** (theory: 0.5000) |
| Fit quality $R^2$ | 0.7581 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.3064$
...
---
*NECF-2026-092-T0 · generated 2026-04-02 · seed 20260402*
