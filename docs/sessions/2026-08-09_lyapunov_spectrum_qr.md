...
# NECF Session Log — 2026-08-09

**Session ID:** `NECF-2026-221-T3`
...
- Coupling $K = 0.8076$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.07654 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.14147 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.15245 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.25574 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.33286 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.34828 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.35520 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.38050 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.07654** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -5.80876 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -9.64071 |
...
With $K = 0.8076$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.0765$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -5.8088$ compared to
$\\text{tr}(J) = -9.6407$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = -0.0765$ provides a
...
---
*NECF-2026-221-T3 · generated 2026-08-09 · seed 20260809*
