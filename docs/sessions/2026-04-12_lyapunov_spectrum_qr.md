...
# NECF Session Log — 2026-04-12

**Session ID:** `NECF-2026-102-T3`
...
- Coupling $K = 0.6225$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.03563 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.16849 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.19299 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.23068 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.32860 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.34573 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.39453 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.40409 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.03563** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -5.88293 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -5.68181 |
...
With $K = 0.6225$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.0356$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -5.8829$ compared to
$\\text{tr}(J) = -5.6818$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = -0.0356$ provides a
...
---
*NECF-2026-102-T3 · generated 2026-04-12 · seed 20260412*
