...
# NECF Session Log — 2026-04-16

**Session ID:** `NECF-2026-106-T0`
...
| Fitted scaling exponent $\\beta$ | **0.1335** (theory: 0.5000) |
| Fit quality $R^2$ | 0.7648 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.1335$
...
---
*NECF-2026-106-T0 · generated 2026-04-16 · seed 20260416*
