...
# NECF Session Log — 2026-06-18

**Session ID:** `NECF-2026-169-T0`
...
| Fitted scaling exponent $\\beta$ | **0.2215** (theory: 0.5000) |
| Fit quality $R^2$ | 0.5166 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.2215$
...
---
*NECF-2026-169-T0 · generated 2026-06-18 · seed 20260618*
