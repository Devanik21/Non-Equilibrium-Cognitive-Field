...
# NECF Session Log — 2026-06-11

**Session ID:** `NECF-2026-162-T0`
...
| Fitted scaling exponent $\\beta$ | **0.3241** (theory: 0.5000) |
| Fit quality $R^2$ | 0.6519 |
...
$K$.  The fitted scaling exponent $\\hat{\\beta} = 0.3241$
...
---
*NECF-2026-162-T0 · generated 2026-06-11 · seed 20260611*
