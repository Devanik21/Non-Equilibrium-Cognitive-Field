...
# NECF Session Log — 2026-07-18

**Session ID:** `NECF-2026-199-T2`
...
|---|---|---|---|---|---|
| 0.01 | ✓ r=0.049 | ✓ r=0.064 | ↓ r=0.018 | ✓ r=0.070 | ↓ r=0.007 |
| 0.05 | ✓ r=0.066 | ↓ r=0.019 | ✓ r=0.045 | ✓ r=0.067 | ✓ r=0.084 |
| 0.10 | ✓ r=0.078 | ✓ r=0.079 | ✓ r=0.120 | ↓ r=0.033 | ✓ r=0.059 |
| 0.25 | ↓ r=0.030 | ✓ r=0.094 | ✓ r=0.099 | ✓ r=0.046 | ✓ r=0.048 |
| 0.50 | ↓ r=0.020 | ✓ r=0.068 | ✓ r=0.121 | ✓ r=0.063 | ↓ r=0.021 |
| 1.00 | ✓ r=0.073 | ↓ r=0.026 | ✓ r=0.070 | ✓ r=0.061 | ✓ r=0.041 |
...
| Best operating point $(\lambda^*, \\delta^*)$ | $(0.5,\\;0.3)$ |
...
---
*NECF-2026-199-T2 · generated 2026-07-18 · seed 20260718*
