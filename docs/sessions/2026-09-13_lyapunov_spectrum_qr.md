...
# NECF Session Log — 2026-09-13

**Session ID:** `NECF-2026-256-T3`
...
- Coupling $K = 0.6643$ (sampled with seed-based variation)
...
|---|---|---|
| $\lambda_{{ 1 }}$ | -0.17314 | negative — contracting direction
| $\lambda_{{ 2 }}$ | -0.27922 | negative — contracting direction
| $\lambda_{{ 3 }}$ | -0.32074 | negative — contracting direction
| $\lambda_{{ 4 }}$ | -0.52347 | negative — contracting direction
| $\lambda_{{ 5 }}$ | -0.54905 | negative — contracting direction
| $\lambda_{{ 6 }}$ | -0.54972 | negative — contracting direction
| $\lambda_{{ 7 }}$ | -0.55220 | negative — contracting direction
| $\lambda_{{ 8 }}$ | -0.56421 | negative — contracting direction

### 3.2 Summary Statistics

| Quantity | Value |
|---|---|
| $\\lambda_1$ (maximal) | **-0.17314** |
| $\\sum_i \\lambda_i$ (Lyapunov sum) | -8.19738 |
| $\\text{tr}(J)$ at final $\\theta$ (consistency check) | -9.09409 |
...
With $K = 0.6643$ and $N = 16$, the system is in the
**stable** regime
($\\lambda_1 = -0.1731$).
...
The Lyapunov sum $\\sum_i \\lambda_i = -8.1974$ compared to
$\\text{tr}(J) = -9.0941$ confirms internal consistency of the
...
This session's QR-derived $\\lambda_1 = -0.1731$ provides a
...
---
*NECF-2026-256-T3 · generated 2026-09-13 · seed 20260913*
